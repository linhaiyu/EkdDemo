/* global RGraph */
/* global myapp */
myapp.controller('algorithm_dis_flowout_controller', ['$scope', 'algorithm_dis_service', function ($scope, algorithm_dis_service) {
    ...
    function algorithm_dis_flowout_init () {
        console.log("algorithm_dis_flowout_controller start...");
        ...
        algorithm_dis_service.reg_update_func("flow_out", update_snr, update_saturation, update_attenuation);

        /* Monitor controller's destroy event */
        $scope.$on("$destroy", function(){
            algorithm_dis_service.unreg_update_func("flow_out");
            console.log("algorithm display flowout controller on destroy");
        });
    };

    algorithm_dis_flowout_init();
}]);