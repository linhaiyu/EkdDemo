myapp.controller('communication_flowin_controller', ['$scope', 'communication_service', function ($scope, communication_service) {
    ...
    var status_indicator = [
        ...
        // {
        //     objname: 'come2',
        //     text_indicator_id: 'come2_status_text',
        //     color_indicator: create_color_indicator('come2_status_indicator')
        // },
        {
            objname: 'afe1',
    ...
    /* Communication flowin Controller Initialization ---------------------------------------------- */

    function communication_flowin_init () {
        console.log('communication flowin controller start...');
        $scope.set_load_page("flowin");
        communication_service.reg_update_func("flow_in", update_communication_status);
    };

    communication_flowin_init();

    /* Monitor controller's destroy event */
    $scope.$on("$destroy", function(){
        communication_service.unreg_update_func("flow_in");
        console.log("communication flowin controller on destroy");
    });
