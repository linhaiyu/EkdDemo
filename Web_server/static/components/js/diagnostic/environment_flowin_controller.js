myapp.controller('environment_flowin_controller', ['$scope', 'environment_service', function ($scope, environment_service){
    ...
    /* Environment Flow In Controller Initialization ---------------------------------------------- */
    var boards_thermometer = [];
    var transducer_thermometer = [];
    var humidity_chart;
    var accelerator_chart;

    function environment_flowin_init () {
        console.log("environment flowin controller start...");
        ...
        environment_service.reg_update_func("flow_in", update_charts);
    };

    environment_flowin_init();

    /* Monitor controller's destroy event */
    $scope.$on("$destroy", function(){
        environment_service.unreg_update_func("flow_in");
        console.log("environment flowin controller on destroy");
    });
}]);
