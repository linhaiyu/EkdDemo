myapp.controller('environment_flowout_controller', ['$scope', 'environment_service', function ($scope, environment_service){
    ...
    function environment_flowout_init () {
        console.log("environment flowout controller start...");
        ...
        environment_service.reg_update_func("flow_out", update_charts);
    };

    environment_flowout_init();

    /* Monitor controller's destroy event */
    $scope.$on("$destroy", function(){
        environment_service.unreg_update_func("flow_out");
