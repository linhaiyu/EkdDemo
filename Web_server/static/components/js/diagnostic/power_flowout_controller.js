myapp.controller('power_flowout_controller', ['$scope', 'power_service', function ($scope, power_service){
    ...
    /* Power Flow Out Controller Initialization ---------------------------------------------- */
    ...
    function power_flowout_init () {
        console.log("power flowout controller start...");
        $scope.set_load_page("flowout");

        // Register a callback function to Service.
        power_service.reg_update_func("flow_out", update_power_charts);
    };
    ...
    $scope.$on("$destroy", function(){
        power_service.unreg_update_func("flow_out");
        console.log("power flowout controller on destroy");
    });
