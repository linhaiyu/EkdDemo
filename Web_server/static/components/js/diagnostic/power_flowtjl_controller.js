myapp.controller('power_flowtjl_controller', ['$scope', 'power_service', function ($scope, power_service){
    ...
    /* Power Flow Tjl Controller Initialization ---------------------------------------------- */
    ...
    function power_flowtjl_init () {
        console.log("power flowtjl controller start...");
        $scope.set_load_page("flowtjl");

        // Register a callback function to Service.
        power_service.reg_update_func("flow_tjl", update_power_charts);
    };
    ...
    $scope.$on("$destroy", function(){
        power_service.unreg_update_func("flow_tjl");
        console.log("power flowtjl controller on destroy");
    });
